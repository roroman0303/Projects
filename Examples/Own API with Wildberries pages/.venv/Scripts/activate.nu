...
let virtual-env = "E:\Projects\Flask\Wildberries_sku\.venv"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("(Wildberries_sku) " != "") {
    "((Wildberries_sku) ) "
} {
...
alias deactivate = source "E:\Projects\Flask\Wildberries_sku\.venv\Scripts\deactivate.nu"
