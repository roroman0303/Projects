...
let virtual-env = "D:\Software\Python Projects\My projects\Examples\Transactions\.venv"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("Transactions" != "") {
    "(Transactions) "
} {
...
alias deactivate = source "D:\Software\Python Projects\My projects\Examples\Transactions\.venv\Scripts\deactivate.nu"
