...
if (thx_3364 == 0)
	...
	case 2
		...
		wait
		dialog "[Lana]"
		dialog "^0000cdTarry Branches^000000 can be obtained from Revived Branches. They were seen in the fields. Strange thing..."
		setquest 3364
		close
		return
	break
...
elseif (thx_3364 == 1)
	...
	if ((v[Fire_Arrow] > 0) & (v[Tree_Root] > 9) & (v[Goodly_Bough] > 4))
		...
		wait
		dialog "[Lana]"
		dialog "The first is a ^0000cdShip Ticket^000000,"
		dialog "<NAVI>[Ship's Captain]<INFO>alberta.gat,140,170,0,101,0</INFO></NAVI> can take you."
		wait
		dialog "[Lana]"
...
if (thx_3364 == 2)
	...
	dialog "Do you want to go home? Or on a trip? Anyway, if you have a ^0000cdShip Ticket^000000, I can take you anywhere. Of course, if 'anywhere' has a port. He-he."
	wait
...
elseif (thx_3371 == 1)
	...
	if (v[Captured_Savage] > 9)
		...
		wait
		dialog "[Serena]"
		dialog "Besides, I think you need a ^0000cdShip Ticket^000000, you must have got tired on the way here. Ask <NAVI>[Ship's Captain]<INFO>alberta.gat,140,170,0,101,0</INFO></NAVI>."
		wait
		dialog "[Serena]"
...
elseif (thx_3375 == 1)
	...
	if ((v[Plain_Sauce] > 0) & (v[Lemon] > 2) & (v[Carrot] > 9))
		...
		wait
		dialog "[Eve]"
		dialog "Thank you very much. You have provided us all with a pleasant evening. As promised, your ^0000cdLottery Ticket^000000."
...
if ((thx_3379 == 1) & (thx_3380 == 0))
	if (v[Grasshopper's_Leg] > 29 ) & (v[Green_Herb] > 19) & (v[Harvest_Cookie] > 19)
		...
		wait
		dialog "[Louie]"
		dialog "Take these ^0000cdLottery Tickets^000000. I got them from disgruntled visitors... Instead of paying..."
		erasequest 3379
		setquest 3380
		dropitem Grasshopper's_Leg 30
		dropitem Green_Herb 20
...
//==============================================================================	
	...
	endchoose
	dialog "[Host Assistant]"
	dialog "Actually, I would like the ^0000cd10 Tarry Branches^000000. I could offer to participate in the lottery for them."
	wait
	...
	case 1
		if (v[Goodly_Bough] > 9)
			...
			dialog "[Host Assistant]"
			dialog "You don't have ^0000cd10 Tarry Branches^000000."
			close
			return
		endif
	break
