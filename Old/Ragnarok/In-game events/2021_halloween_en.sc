...
npc "niflheim" "Portal#2021hw_prt" 1_SHADOW_NPC 177 248 6 3 3
OnClick:
	dialog "*whisper*"
	dialog "You will come back anyway..."
	dialog "Sooner or later..."
	wait
	choose menu "Return to Prontera" "Cancel"
	case 1
		close
...
npc "prontera" "Bright#2021hw_prt" 4_LUDE 134 122 3 5 5
OnInit:
...
if (v[VAR_CLEVEL] < 20)
    ...
    choose menu "Keep listening" "Leave "
        ...
        Talk2me "Horro#2021hw_prt" "Horro: Almost!"
        wait
    choose menu "Move to Niflheim" "Leave "
        case 1
            dialog "[Phobos]"
            dialog "Oh, it's Jack!"
            wait
...
npc "niflheim" "Jack#2021hw_j6" 4_JACK_HEAD 184 202 3 0 0
OnClick:
...
npc "alberta" "Pile of ash#2021hw" 4_SOIL 199 51 1 0 0
OnClick:
if (v[halloebs02] < 10)
...
npc "niflheim" "Skelion#2017hw" 4_SKELION 138 199 5 0 0
OnClick:
	dialog "[Skelion]"
	...
	wait
	dialog "- You can upgrade Skelitty. You need ^ff00001 Skelitty Egg, 2 Memories of Skelion, 100 Yummy Meat, 100 Bat Cookie^000000. -"
	wait
