...
let virtual-env = "E:\Projects\Python\Kraken_rates\.venv"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("(Kraken_rates) " != "") {
    "((Kraken_rates) ) "
} {
...
alias deactivate = source "E:\Projects\Python\Kraken_rates\.venv\Scripts\deactivate.nu"
